          ...
          {!isAuthenticated ? (
            <>
              ...
              <button className="header__country" type="button">
                ...
                <img src={flagUs} alt="US flag" className="header__country-flag" />
              </button>
            </>
          ) : (
            <>
              ...
              <Link to="/create-event" className="header__nav-link" onClick={closeMenu}>
                Create Event
              </Link>

              <Link to="/account" className="header__nav-link" onClick={closeMenu}>
                Account
              </Link>

              <button className="header__icon-btn header__icon-btn--bell" type="button">
                <img src={bellIcon} alt="Notifications" className="header__icon" />
                {hasNewNotifications && <span className="header__dot" />}
              </button>

              <button className="header__cart" type="button">
                <span className="header__cart-price">{cartTotal}</span>

                <span className="header__cart-icon-wrap">
                  <img src={cartIcon} alt="Cart" className="header__icon" />
                  {hasNewCartItems && <span className="header__dot header__dot--cart" />}
                </span>
              </button>
